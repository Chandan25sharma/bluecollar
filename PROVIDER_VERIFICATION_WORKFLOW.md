...
<PendingProvidersTable>
  - Provider Name - Email - Submitted Date - Documents Status - Actions
  (View/Approve/Reject)
</PendingProvidersTable>
```
...
```tsx
<Banner type="warning">
  ⏳ Your account is under review. You'll be notified once verified by our team.
...
```tsx
<Banner type="success">
  ✅ Your account is verified! You can now create services and accept bookings.
</Banner>
```
