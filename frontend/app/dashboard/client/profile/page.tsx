        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">Manage your account settings and addresses</p>
            </div>
            <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="p-6 border-2 border-gray-200 rounded-xl">
                      ...
                      <p className="text-lg font-semibold text-gray-900">{profile?.age || "Not specified"}</p>
                    </div>
                  </div>

                  {profile?.address && (
                    <div className="p-6 border-2 border-gray-200 rounded-xl">
                      <label className="block text-sm font-medium text-gray-500 mb-2">Primary Address</label>
