    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setStats({
          ...
          revenue: 86450,
          pendingBookings: 23,
          completedBookings: 2897,
          activeProviders: 67,
          platformEarnings: 12967
        });
        ...
        setRecentActivities([
          ...
          },
          {
            id: "2",
            type: "provider",
            action: "Provider signed up",
            user: "Mike's Plumbing",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">{stats.activeProviders} active</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-600">{formatCurrency(stats.platformEarnings)}</p>
                <p className="text-sm text-gray-500 mt-1">From {formatNumber(stats.completedBookings)} bookings</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Approve and manage providers</p>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Handle Payouts</h3>
                    <p className="text-sm text-gray-500">Process provider payments</p>
                  </div>
                </Link>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/dashboard/admin/activity" className="text-sm text-blue-600 hover:text-blue-800">
                  View all activity →
                </Link>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <h2 className="text-lg font-medium text-gray-900 mb-6">Revenue Summary</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <p className="text-2xl font-bold text-green-600">{formatCurrency(stats.platformEarnings)}</p>
              <p className="text-sm text-gray-600">Platform Earnings</p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <p className="text-2xl font-bold text-purple-600">{formatCurrency(stats.revenue - stats.platformEarnings)}</p>
