...
export default function AdminUsersPage() {
  ...
  const getUserName = (user: User) => {
    ...
    if (user.providerProfile?.name) return user.providerProfile.name;
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="text-sm text-gray-600 flex items-center">
                ...
                <span className="font-semibold ml-1">
                  {users.length > 0 ? `${(page - 1) * 20 + users.length}+` : 0}
                </span>
              </div>
            </div>
          </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          ...
                          {user.role === "PROVIDER" && user.providerProfile && (
                            <span
                              className={`ml-2 inline-flex px-3 py-1 text-xs font-semibold rounded-full ${
